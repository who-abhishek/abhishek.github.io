                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              <label>Date Of Birth</label>
                               <input type="text" name="dob"  placeholder="Enter (dd/MM/yyyy)" class="form-control input-md"  value="<%=DataUtility.getDateString(bean.getDob())%>" >
                         ...
                         <div class="row">
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              ...
                              <textarea rows="3" cols="5" name="spcialization" class="form-control input-md" ><%=DataUtility.getStringData(bean.getSpcialization()) %></textarea> 
